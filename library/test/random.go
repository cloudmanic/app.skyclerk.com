...
//
func GetRandomLedger() models.Ledger {
	...
	ledger := models.Ledger{
		...
		Labels:    []models.Label{GetRandomLabel(), GetRandomLabel(), GetRandomLabel()},
	}
...
//
func GetRandomContact() models.Contact {
	rand.Seed(time.Now().UnixNano())
...
//
func GetRandomCategory() models.Category {
	rand.Seed(time.Now().UnixNano())
...
//
func GetRandomLabel() models.Label {
	rand.Seed(time.Now().UnixNano())

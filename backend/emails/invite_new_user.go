																							...
																							<td align="left" class="EQ-05" width="500">
																								<div class="text" style="font-size: 16px; font-family: 'Lucida Grande'; line-height: 1.2;">
																									...
																									<div style="line-height: 1.2;">
																										<font face="Roboto, Times New Roman, sans-serif"><b style="font-size: 16px;">` + name + `</b><span style="font-size: 16px;">&nbsp;invited you to the&nbsp;</span><b style="font-size: 16px;">` + accountName + `</b><span style="font-size: 16px;">&nbsp;Skyclerk
																												account.</span></font><span style="font-family: Roboto, &quot;Times New Roman&quot;, sans-serif;">&nbsp;</span>
																									</div>

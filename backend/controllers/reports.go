...
//
// ReportsPnlLabel - Return PnL by Label
//
func (t *Controller) ReportsPnlLabel(c *gin.Context) {
	...
	// Run function
	result := reports.GetLabelsPnL(t.db, uint(c.MustGet("accountId").(int)), start, end, c.DefaultQuery("sort", "desc"))

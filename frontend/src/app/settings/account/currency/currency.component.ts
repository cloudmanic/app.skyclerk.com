...
export class CurrencyComponent {
	...
	setActiveName() {
		for (let i = 0; i < this.currencyNames.length; i++) {
			if (this.currencyNames[i].code == this.account.Currency) {
				this.currencyName = this.currencyNames[i].name;
				this.currencyCode = this.currencyNames[i].code;
			}
		}
	}
	...
	onChange() {
		for (let i = 0; i < this.currencyNames.length; i++) {
			if (this.currencyNames[i].code == this.currencyCode) {
				this.currencyName = this.currencyNames[i].name;
				this.currencyLocale = this.currencyNames[i].locale;
			}
		}
	}
